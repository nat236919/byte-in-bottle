...
class TestChatRouter:
    ...
    def mock_services(self):
        ...
        with (
            patch("api.routers.v1.chats.api_chat_router.cache_service") as mock_cache,
            patch("api.routers.v1.chats.api_chat_router.core_service") as mock_core,
        ):
            # Default mocks
    ...
    def test_ask_endpoint_success(self, client, mock_services):
        ...
        payload = {"model": "llama3.2", "prompt": "What is AI?", "mode": "concise"}
    ...
    def test_ask_endpoint_all_modes(self, client, mock_services):
        ...
        modes = ["concise", "professional", "sarcastic", "creative", "friendly"]

        for mode in modes:
            payload = {"model": "llama3.2", "prompt": "Test", "mode": mode}
            response = client.post("/v1/chats/ask", json=payload)
            assert response.status_code == 200
    ...
    def test_ask_endpoint_generation_error(self, client, mock_services):
        ...
        mock_core.generate_text = AsyncMock(side_effect=Exception("Generation failed"))
    ...
    def test_ask_endpoint_invalid_mode(self, client):
        ...
        payload = {"model": "llama3.2", "prompt": "What is AI?", "mode": "invalid_mode"}
    ...
    def test_ask_endpoint_missing_fields(self, client, mock_services):
        ...
        response = client.post("/v1/chats/ask", json={"prompt": "Test"})
