...
class TestAskRequest:
    ...
    def test_custom_values_and_all_modes(self):
        ...
        for mode in AskMode:
            request = AskRequest(model="mistral", prompt="Test prompt", mode=mode)
...
class TestAskResponse:
    ...
    def test_all_modes(self):
        ...
        for mode in ["concise", "professional", "sarcastic", "creative", "friendly"]:
            response = AskResponse(
                model="llama3.2",
                response="Test",
                created_at="2025-11-01T12:00:00Z",
    ...
    def test_edge_cases(self):
        ...
        # Long response
        long_text = "A" * 100000
        assert len(AskResponse(**base_args, response=long_text).response) == 100000
        # Special characters
        special = "émojis 🎉 中文"
