...
class TestCoreService:
    ...
    def service(self):
        ...
        with (
            patch("api.services.core_service.ollama.Client"),
    ...
    def test_async_ollama_client_with_host(self):
        ...
        with patch.dict(os.environ, {"OLLAMA_HOST": "http://custom:11434"}):
            with patch("api.services.core_service.ollama.AsyncClient") as mock:
                service = CoreService()
    ...
    async def test_get_ollama_models(self, service):
        ...
        service.async_ollama_client.list = AsyncMock(return_value=mock_response)
    ...
    async def test_generate_text_basic(self, service):
        ...
        service.async_ollama_client.generate = AsyncMock(return_value=mock_response)
    ...
    async def test_generate_text_with_system_prompt(self, service):
        ...
        result = await service.generate_text(
            "llama3.2", "Test prompt", "System instruction"
        )
