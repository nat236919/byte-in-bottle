...
class TestCacheService:
    ...
    def service(self, mock_redis):
        ...
        with patch(
            "api.services.cache_service.redis.from_url", return_value=mock_redis
        ):
            return CacheService()
    ...
    async def test_get_cached_response_hit(self, service, mock_redis):
        ...
        result = await service.get_cached_response("llama3.2", "test", "concise")
    ...
    async def test_cache_response_custom_ttl(self, service, mock_redis):
        ...
        await service.cache_response("llama3.2", "test", {}, "concise", ttl=1800)
    ...
    async def test_cache_response_error(self, service, mock_redis):
        ...
        result = await service.cache_response("llama3.2", "test", {}, "concise")
